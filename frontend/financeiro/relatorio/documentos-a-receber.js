...
function configurarEventListeners() {
    ...
    // Select tipo de período para atualizar contexto
    const tipoPeriodo = document.getElementById('tipoPeriodo');
    if (tipoPeriodo) {
...
function coletarDadosFormulario() {
    ...
    const campos = [
        'periodo', 'tipoPeriodo', 'tipoDocumento', 
        'cliente', 'selecao'
    ];
...
function visualizarRelatorio() {
    ...
    console.log('Dados do relatório Documentos a Receber:', dados);
    ...
    setTimeout(() => {
        alert('Relatório de Documentos a Receber Emitidos gerado com sucesso!\n\nFuncionalidade de geração de relatório será implementada em breve.');
...
function limparFormulario() {
    ...
    console.log('Formulário Documentos a Receber limpo');
}
