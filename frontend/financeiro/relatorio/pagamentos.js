...
function coletarDadosFormulario() {
    ...
    const campos = [
        'periodo', 'tipoImpressao', 'tipoDocumento',
        'profissionalFornecedor', 'tag'
    ];
...
function visualizarRelatorio() {
    ...
    console.log('Dados do relatório de Pagamentos:', dados);
...
function limparFormulario() {
    ...
    console.log('Formulário de Pagamentos limpo');
}
