...
const configuracoesPadrao = {
    periodo: '07/11/2025 - 07/11/2025',
    dataFiltro: 'vencimento',
    tipoRelatorio: 'porData',
    tipoImpressao: 'completo',
    tipoDocumento: 'todos',
    profissionalFornecedor: 'todos',
    centroResultado: 'todos',
    categoriaFinanceira: 'todos',
    selecao: 'comPrevisao',
...
function configurarEventListeners() {
    ...
    // Checkbox mostrar observações
    const mostrarObservacoes = document.getElementById('mostrarObservacoes');
    if (mostrarObservacoes) {
        mostrarObservacoes.addEventListener('change', function() {
            console.log('Mostrar observações:', this.checked);
        });
    }

    // Select data filtro para atualizar contexto
    const dataFiltro = document.getElementById('dataFiltro');
    if (dataFiltro) {
        dataFiltro.addEventListener('change', function() {
            console.log('Data utilizada para filtro alterada para:', this.value);
        });
    }
}
...
function coletarDadosFormulario() {
    ...
    const campos = [
        'periodo', 'dataFiltro', 'tipoRelatorio', 'tipoImpressao',
        'tipoDocumento', 'profissionalFornecedor', 'centroResultado',
        'categoriaFinanceira', 'selecao'
    ];
    ...
    // Checkbox
    const mostrarObservacoes = document.getElementById('mostrarObservacoes');
    dados.mostrarObservacoes = mostrarObservacoes ? mostrarObservacoes.checked : false;
...
function visualizarRelatorio() {
    ...
    console.log('Dados do relatório A Pagar:', dados);
...
function limparFormulario() {
    ...
    const mostrarObservacoes = document.getElementById('mostrarObservacoes');
    if (mostrarObservacoes) {
        mostrarObservacoes.checked = false;
    }
    
    console.log('Formulário A Pagar limpo');
}
