...
// Definir pelagens predefinidas (tipos + cores) para a página de Pelagem
// Cada item tem { nome: '<cor>', tipo: '<pelagem>' }
window.pelagensPredefinidas = window.pelagensPredefinidas || [
    { nome: 'Branco', tipo: 'Curta' },
    { nome: 'Preto', tipo: 'Curta' },
    { nome: 'Marrom', tipo: 'Curta' },
    { nome: 'Caramelo', tipo: 'Curta' },
    { nome: 'Malhado', tipo: 'Curta' },
    { nome: 'Tigrado', tipo: 'Curta' },
    { nome: 'Cinza', tipo: 'Curta' },

    { nome: 'Branco', tipo: 'Longa' },
    { nome: 'Preto', tipo: 'Longa' },
    { nome: 'Malhado', tipo: 'Longa' },
    { nome: 'Tricolor', tipo: 'Longa' },

    { nome: 'Sem Pelo', tipo: 'Sem Pelo' },
    { nome: 'Curto e Denso', tipo: 'Curta e Densa' },
    { nome: 'Ondulado', tipo: 'Ondulada' },
    { nome: 'Liso', tipo: 'Lisa' },
    { nome: 'Riscado', tipo: 'Riscada' },
    { nome: 'Mesclado', tipo: 'Mesclada' },
    { nome: 'Creme', tipo: 'Curta' },
    { nome: 'Amarelo', tipo: 'Curta' },
    { nome: 'Castanho', tipo: 'Curta' }
];
