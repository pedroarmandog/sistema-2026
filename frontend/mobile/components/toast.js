/* ============================================================
   PetHub Mobile — Toast Notifications Component
   Exibe notificações inline (sucesso, erro, info, aviso).
   ============================================================ */

window.MobileToast = (function () {
  "use strict";

  const DURACAO = { success: 3000, error: 5000, info: 3500, warning: 4000 };
  const ICONS = {
  ...
  function show(message, type = "info") {
    ...
    // Auto-dismiss
    const timer = setTimeout(() => dismiss(toast), DURACAO[type] || 3500);
  ...
  return { show, dismiss, success, error, info, warning };
})();
