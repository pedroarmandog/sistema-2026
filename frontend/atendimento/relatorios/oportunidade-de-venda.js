...
document.addEventListener('DOMContentLoaded', function() {
    ...
    inicializarRelatorioOportunidade();
});

// ========================================
// FUNCIONALIDADES DO RELATÓRIO DE OPORTUNIDADE DE VENDA
// ========================================

function inicializarRelatorioOportunidade() {
    console.log('🚀 Inicializando funcionalidades do Relatório de Oportunidade de Venda');
...
function configurarFiltros() {
    ...
    const filtros = ['cliente', 'profissional', 'produto'];
...
function visualizarRelatorio() {
    ...
    console.log('📊 Gerando relatório de oportunidade de venda com filtros:', filtros);
    
    // Validar período
    if (!filtros.dataInicio || !filtros.dataFim) {
        mostrarNotificacao('Por favor, selecione o período de análise.', 'warning');
        return;
    }
    ...
    mostrarNotificacao('Analisando oportunidades de venda...', 'info');
    
    setTimeout(() => {
        mostrarNotificacao('Relatório de oportunidade de venda gerado com sucesso!', 'success');
        processarRelatorioOportunidade(filtros);
    }, 1500);
}
...
function limparFiltros() {
    ...
    const selects = ['cliente', 'profissional'];
...
function processarRelatorioOportunidade(filtros) {
    // Aqui você faria a integração com o backend
    console.log('🔄 Processando relatório de oportunidade no backend...', filtros);
    
    // Simulação de dados de exemplo
    const dadosRelatorio = {
        periodo: `${filtros.dataInicio} à ${filtros.dataFim}`,
        totalOportunidades: 45,
        valorPotencial: 15750.00,
        conversao: 68.9,
        oportunidades: [
            { 
                cliente: 'João Silva', 
                profissional: 'Dr. João Silva',
                produto: 'Consulta + Vacina',
                ultimoContato: '05/11/2025',
            ...
            { 
                ...
                produto: 'Cirurgia Castração',
                ultimoContato: '04/11/2025',
...
function mostrarNotificacao(mensagem, tipo = 'info') {
    ...
    notification.style.cssText = `
        ...
        animation: slideIn 0.3s ease forwards, slideOut 0.3s ease 3.7s forwards;
    `;
...
console.log('✅ Funcionalidades do Relatório de Oportunidade de Venda carregadas');
