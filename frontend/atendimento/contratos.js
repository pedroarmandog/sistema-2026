...
function gerarHTMLRelatorio(dados) {
    ...
    return [
        ...
        },
        {
            ...
            plano: '301 - Assinatura Teddy - 2 Banhos/Mês - Hidratação e Escovação Dental',
            dia: 'Quarta',
            levaTraz: 'Não',
            valorLeva: 0.00,
            valor: 120.00
...
<head>
    ...
    <title>Relatório de Contratos - Pet Cria LTDA</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="header">
        <div class="logo">
            <img src="/logos/logo_pet_cria-removebg-preview.png" alt="Pet Cria LTDA">
        </div>
        <div class="title">RELATÓRIO DE CONTRATOS</div>
        <div class="subtitle">PET CRIA LTDA</div>
    </div>
...
function criarJanelaRelatorio(htmlContent) {
    ...
    const popup = window.open('', 'RelatorioContratos', 
