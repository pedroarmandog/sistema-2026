    ...
    try {
        ...
        if (agendamentosExistentes.length === 0) {
            ...
            for (const agendamentoData of agendamentosParaCriar) {
                ...
                console.log(`Agendamento criado: ${agendamento.servico} - Status: ${agendamento.status}`);
            }
            
            console.log('Agendamentos de teste criados com sucesso!');
        } else {
            console.log(`${agendamentosExistentes.length} agendamentos já existem no sistema.`);
        }
